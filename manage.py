...
@token_required
def index():
    """Process / routes and returns 'Welcome to the ecommerce api"""
    return jsonify(dict(message='Welcome to the ecommerce api'))
...
#             'Message sent!' 
#     """
#     sse.publish({"message": "This was automatically sent by server"}, type='testing')
#     return "Message sent!"
